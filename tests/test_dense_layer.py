...
def build_hf_small_config():
    ...
    global LOAD_REAL_671B_MODEL, MOE
    if LOAD_REAL_671B_MODEL:
        return DeepseekV3Config.from_pretrained("deepseek-ai/DeepSeek-V3.1-Base")
...
def build_tt_args_from_hf(cfg):
    from torchtitan.models.deepseek_v3.model.args import (
        DeepSeekV3ModelArgs,
    )
